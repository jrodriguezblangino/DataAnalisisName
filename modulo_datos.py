...
def cargar_datasets():
    archivos = {
        "apellidos_provincia": "apellidos_cantidad_personas_provincia_clean.csv",
        "apellidos_pais": "apellidos_mas_frecuentes_pais_clean.csv",
        "apellidos_provincia_ranking": "apellidos_mas_frecuentes_provincia_clean.csv",
        "historico_nombres": "historico-nombres_clean.csv"
    }
